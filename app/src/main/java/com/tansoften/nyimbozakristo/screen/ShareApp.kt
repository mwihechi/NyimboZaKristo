...
fun ShareApp(){
   // navController.navigate(DrawerScreens.AllSongScreen.route)
    ...
    val appText = "Soma Nyimbo Za Kristo kirahisi kabisa, muonekano mzuri na uwezo wa kupangilia vitu kama utakavyo wewe. Ipakue sasa kupitia link hii hapo chini. \r\n $APP_URL"
